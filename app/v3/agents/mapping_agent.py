...
class MappingAgent:
    ...
    def _load_mapping_rules(self):
        """Load rule-based mappings for MT103 to pacs.008"""
        self.rule_mappings = {
            ...
            'ordering_customer': {
                ...
                'confidence': 0.97,
                'reasoning': 'Ordering customer is debtor in ISO 20022'
            },
            ...
            'beneficiary_customer': {
                ...
                'confidence': 0.97,
                'reasoning': 'Beneficiary customer is creditor in ISO 20022'
            },
            'remittance_info': {
