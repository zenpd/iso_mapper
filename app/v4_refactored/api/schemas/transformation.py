...
class TransformationRequest(BaseModel):
    ...
    Attributes:
        ...
        direction: Transformation direction (mt_to_iso or iso_to_mt)
    """

    mt_message: str = Field(
        ..., description="Raw SWIFT MT message text or ISO 20022 XML", min_length=1
    )
    ...
    direction: Optional[str] = Field(
        default=None, description="Transformation direction: 'mt_to_iso' or 'iso_to_mt'"
    )
