      ...
      <Card title="About">
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            A modern, agentic MT to MX transformation platform following PayOrch architecture
            standards. Built with FastAPI (backend), React (frontend), LangGraph (agents), and
